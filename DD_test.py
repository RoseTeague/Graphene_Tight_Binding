...
def disorder_potential(lattice, V): 
    ...
    """
    ===========================================================================
    Calculation of the disorder potential
    ===========================================================================
...
def hamiltonians (lattice, V, form):
    ...
    V       - string
            - description of the potential to be used on the system. This can be
                either 'None', 'one dimensional' or 'two dimensional'.
    form    - string
            - description of the form of the hamiltonian to be used on the system. This can be
                either 'full', 'tridiagonal', by default it runs as tridiagonal.
    m  - integer,
        number of atoms along x
    ...
    if lattice == 'square':
       ...
       #  Check for the form of the hamiltonian                  
        if form == 'full':
...
def wavepackets(lattice):
    ...
    """
    ===========================================================================
    Calculation of the Wavepackets
    ===========================================================================
    ...
    Returns
    ----------
    Contour plot of the wavepacket
    """
